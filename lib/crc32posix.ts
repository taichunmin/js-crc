 ...
 * - refout: false
 */
export default function crc32posix (buf: Uint8Array = new Uint8Array(), prev: number = 0xFFFFFFFF): number {
...
Object.assign(((globalThis as any || {}).taichunmin ||= {}).crc ||= {}, { crc32posix })
