 ...
 */
const xorout = 0xFF
export default function crc8saej1850 (buf: Uint8Array = new Uint8Array(), prev: number = 0x00): number {
  u8[0] = prev ^ xorout // revert xorout
  for (const b of buf) u8[0] = POLY_TABLE[u8[0] ^ b]
  return u8[0] ^ xorout // revert xorout
}

setObject(globalThis, ['taichunmin', 'crc', 'crc8saej1850'], crc8saej1850)
