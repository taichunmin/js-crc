 ...
 * - refout: true
 */
export default function crc16riello (buf: Uint8Array = new Uint8Array(), prev: number = 0x554D): number {
  u16[0] = prev // revert of refout and xorout
  for (const b of buf) u16[0] = POLY_TABLE[(u16[0] ^ b) & 0xFF] ^ (u16[0] >>> 8)
  return u16[0]
}

setObject(globalThis, ['taichunmin', 'crc', 'crc16riello'], crc16riello)
