 ...
 * - refout: true
 */
export default function crc16philips (buf: Uint8Array = new Uint8Array(), prev: number = 0xC592): number {
  u16[0] = prev // revert of refout and xorout
  for (const b of buf) u16[0] = POLY_TABLE[(u16[0] ^ b) & 0xFF] ^ (u16[0] >>> 8)
  return u16[0]
}

setObject(globalThis, ['taichunmin', 'crc', 'crc16philips'], crc16philips)
